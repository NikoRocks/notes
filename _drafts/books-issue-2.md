...
Не помню, как именно наткнулся на эту книгу - кажется, услышал о ней в одной из
лекций то ли Ричча Хикки, то ли Алана Кея - где советовалось прочесть ее, дабы
понять, как решать проблемы *правильно*. Книга очень короткая и, в принципе, хорошая
выжимка основных идей есть на соответсвтующей статье (https://en.wikipedia.org/wiki/How_to_Solve_It)
в Википедии. В принципе, основные четыре шага есть суть научного метода.

Несмотря на то что она короткая, в ней, как я понимаю, есть почти все, что пропагандируется
апологетами ТРИЗ (ссылка на пост), за минусом пафоса, аббривиатур и платных книжек.
Автор
ориентируется и воспринимает читателя как преподавателя математики, который
хочет не просто дать ученикам простые знания, но и научить их думать. Книга потому разделена
на две части: в первой описывается процесс "постановки" мышления ученика, когда
учитель пытается путем постановки правильных вопросов натолкнуть ученика
на идеи о том, как решить задачу; вторая часть, большая часть, - это
своего рода "словарик эвристик", то есть методов решения проблем,
а также связанных терминов.

Эта книжка, разумеется, будет полезна не только и не столько учителям,
но и всем кто желает улучить свой скилл решения проблем и заставить
его служить себе, а не дожидаться неведомых, неконтроллируемых "озарений".
Не смотря на то что написана давно, актуальность она не утратила - просто
потому, что методы используется в ней известные давно, и ничего существенного
нового человечество за это время не придумало. Здесь же информация систематезирована
и подана в удобном виде.
Советую, хотя бы потому что короткая. Да и сам перечитаю, ведь повторение -
мать учение.

J. Armstrong. Making reliable distributed systems in the presence of software errors (2003)
-------------------------------------------------------------------------------------------

Эта открыто достуная (http://erlang.org/download/armstrong_thesis_2003.pdf) книжка не книжка
даже, а диссертация на соискание докторской степени за авторством автора языка Erlang Джо
Армстронга. Наткнулся на нее когда смотрел видео The Language of the System Рича Хикки, который
крайне советую. Суть в том, что автор выдвигает свое видение того, как нужно строить распределенные
системы с учетом присутствующих ошибок (которые, как мудро замечается, будут присутсвовать
в распределенных системах всегда и пытаться их победить - глупо, вместо этого нужно
научиться их исправлять). Приводятся и обосновываются основные компоненты подобных систем
и их свойства, характеристики, при чем учитываются не только технические преимущества, но
в том числе и полезность бизнесу (???) - как построенные системы ложаться на распределенные
и крупные отделы разработки.

В итоге делается попытка реализовать платформу, основанную на этих принципах - Erlang.
Вводится краткий, но, как я понимаю, объемный инструктаж по языку и фреймворку OTP,
а также планы по дальнейшему их развитию.

Диссертация, несмотря на ее кратость, произвела на меня неизгладимое впечатление,
я теперь совсем иначе смотрю на то, как нужно строить системы. Хотя в качестве ответа
и предлагается Erlang, все же основные идеи можно попытаться реализовать и самостоятельно,
на том что имеется. Я *крайне* советую прочесть этот труд. Хотя он и не совсем о
языке программирования - но меж тем это лучшее введение в ЯП которое я когда-либо
читал (https://twitter.com/neoascetic/status/849274929140953089): здесь
объясняется не просто что язык из себя представляет, но и то, *зачем* он нужен
и *почему* сделан именно таким. Masterpiece.
